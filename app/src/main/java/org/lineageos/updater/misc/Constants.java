...
public final class Constants {
    ...
    public static final String PROP_RELEASE_TYPE = "ro.gitdaisy.releasetype";
    public static final String PROP_RELEASE_TYPE_DEFAULT = "release";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "gitdaisy.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "gitdaisy.updater.uri";
